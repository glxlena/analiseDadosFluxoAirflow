...
with DAG(
    ...
    wait_for_upload = ExternalTaskSensor(
        ...
        external_dag_id="acidentes_bronze_dag",
        external_task_id="run_acidentes_bronze",
        mode="poke",
        timeout=600,
        poke_interval=30
    )
    ...
    run_spark_job = BashOperator(
        ...
        /opt/spark-jobs/acidentesFerroviarios/silver.py
        """
    )
