...
with DAG(
    ...
    wait_for_upload = ExternalTaskSensor(
        ...
        external_dag_id="acidentesConsolidados_silver_dag",
        external_task_id="run_acidentesConsolidados_silver",
        mode="poke",
        timeout=600,
        poke_interval=30
    )
    ...
    run_spark_job = BashOperator(
        ...
        /opt/spark-jobs/acidentesFerroviarios/gold.py
        """
    )
