...
with DAG(
    dag_id="acidentesConsolidados_silver_dag",
    schedule="30 14 * * *",  # roda depois da ingestão
    ...
    wait_for_upload = ExternalTaskSensor(
        ...
        external_dag_id="acidentes_silver_dag",
        external_task_id="run_acidentes_silver",
        mode="poke",
        timeout=600,
        poke_interval=30
    )
    ...
    run_spark_job = BashOperator(
        task_id="run_acidentesConsolidados_silver",
        bash_command="""
        ...
        /opt/spark-jobs/acidentesFerroviarios/silver_consolidada.py
        """
    )
