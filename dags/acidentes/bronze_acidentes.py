...
with DAG(
    ...
    wait_for_upload = ExternalTaskSensor(
        ...
        external_dag_id="upload_acidentes",
        external_task_id="upload_jsons_acidentes",
        mode="poke",
        timeout=600,
        poke_interval=30
    )
    ...
    run_spark_job = BashOperator(
        ...
        /opt/spark-jobs/acidentesFerroviarios/bronze.py
        """
    )
