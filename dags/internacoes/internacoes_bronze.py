...
with DAG(
    ...
    wait_for_upload = ExternalTaskSensor(
        ...
        external_dag_id="upload_internacoes",
        external_task_id="upload_csv_internacoes",
        mode="poke",
        timeout=600,
        poke_interval=30
    )
    ...
    run_spark_job = BashOperator(
        task_id="run_internacoes_bronze",
        bash_command="""
        ...
        /opt/spark-jobs/internacoes/bronze.py
        """
    )
